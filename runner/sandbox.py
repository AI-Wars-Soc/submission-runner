...
class TimedContainer:
    ...
    def _lock_down(self):
        # Set write limits
        logger.debug(self._container.exec_run("chmod -R ugo=rx /home/sandbox/", user='root').output.decode())  # TODO: Very slow (~2s) because of CoW?
        logger.debug(self._container.exec_run("ls -alR /home/sandbox/", user='read_only_user').output.decode())
